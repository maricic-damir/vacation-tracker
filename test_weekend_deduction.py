...
def test_weekend_counting():
    """Test that weekend days (excluding holidays) are counted correctly."""
    ...
    print(f"Working days: {working} (expected: 5)")
    print(f"Weekend days: {weekend} (expected: 2 - Sat Jan 10, Sun Jan 11)")
    print(f"Total deductible: {total} (expected: 7)")
    assert working == 5, f"Expected 5 working days, got {working}"
    assert weekend == 2, f"Expected 2 weekend days, got {weekend}"
    assert total == 7, f"Expected 7 total days, got {total}"
    print("✓ PASSED\n")
    ...
    print(f"Working days: {working} (expected: 0)")
    print(f"Weekend days: {weekend} (expected: 1 - only Sat, Sun is holiday)")
    print(f"Total deductible: {total} (expected: 1)")
    assert working == 0, f"Expected 0 working days, got {working}"
    ...
    print("Test 6: Full week with both weekends")
    print("=" * 50)
    ...
    print(f"Working days: {working} (expected: 10)")
    print(f"Weekend days: {weekend} (expected: 4 - two Saturdays, two Sundays)")
    print(f"Total deductible: {total} (expected: 14)")
    assert working == 10, f"Expected 10 working days, got {working}"
    assert weekend == 4, f"Expected 4 weekend days, got {weekend}"
    assert total == 14, f"Expected 14 total days, got {total}"
    print("✓ PASSED\n")
    ...
    print("=" * 50)
    print("\nSummary:")
    print("- Weekend days (Sat/Sun) that are NOT holidays are now counted")
    print("- These days will be deducted from the vacation bucket")
